...
class Caja extends CI_Controller {
	...
	public function ingreso_caja(){
	    ...
	    $this->template->load('view_layout_modern', 'caja/index', $this->data);
	...
	function ver_cajas(){
		...
		$this->template->load('view_layout_modern', 'caja/ver_cajas', $this->data);
	}
	...
	function aperturar_caja(){
		...
		if (!$this->caja_model->existe_cajas_abiertas()){
			$this->template->load('view_layout_modern', 'caja/aperturar_caja', $this->data);
		}else{
			$this->data['page_title'] 	= "Cajas";
	...
	function cuadre($caja_id=1, $store_id=1, $fecha=''){
		...
		$this->template->load('view_layout_modern', 'caja/cuadre', $this->data);
	}
	...
	function analisis_mensual(){
		if(isset($_POST["anno"])){
			...
			$this->template->load('view_layout_modern', 'caja/rpta_analisis_mensual', $this->data);
		}else{
			$this->data['page_title'] = "ANALISIS MENSUAL";
			$this->template->load('view_layout_modern', 'caja/analisis_mensual', $this->data);
		}
	}
}
