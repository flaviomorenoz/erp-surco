...
//error_reporting(E_ALL & ~E_DEPRECATED & ~E_USER_DEPRECATED); // Muestra todos los errores y advertencias
...
class Clientes extends CI_Controller {
	...
	public function index()
	{
		...
		$this->template->load('view_layout_modern', 'clientes/index', $this->data);
	}
    ...
    function add($cerrar=null){
		...
		$this->template->load('view_layout_modern', 'clientes/add', $this->data);    	
    }
