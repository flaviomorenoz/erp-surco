...
class Gastos extends CI_Controller {
    ...
    function index($store_id='', $cDesde='null', $cHasta='null') {
        ...
        $this->template->load('view_layout_modern', 'gastos/index', $this->data);
    }
    ...
    function add($id=null){
        ...
        $this->template->load('view_layout_modern', 'gastos/add', $this->data);
    }
    ...
    function buscar2(){ // Para Compras, devuelve texto
        ...
        $cSql = "select a.*, if(b.stock is null,0,b.stock) stock, c.name categoria, a.impuesto 
            from tec_products a 
