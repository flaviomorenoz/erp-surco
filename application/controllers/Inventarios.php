...
class Inventarios extends CI_Controller {
    ...
    function index($cDesde='null', $cHasta='null') {
        ...
        $this->template->load('view_layout_modern', 'inventarios/index', $this->data);
    }
    ...
    function add() {
        ...
        if(isset($_POST["tienda"])){
            ...
            $this->template->load('view_layout_modern', 'inventarios/add', $this->data);
    ...
    function add_movimientos(){
        ...
        $this->template->load('view_layout_modern', 'inventarios/add_movimientos', $this->data);
    }
    ...
    function add_traslados(){
        ...
        $this->data['tipos_mov'] = $this->db->select('*')->get("tec_tipos_mov");
        $this->template->load('view_layout_modern', 'inventarios/add_traslados', $this->data);
    }
    ...
    function ver_movimientos($cDesde='null', $cHasta='null') {
        ...
        $this->template->load('view_layout_modern', 'inventarios/ver_movimientos', $this->data);
    }
    ...
    function stock_productos(){
        ...
        $this->template->load('view_layout_modern', 'inventarios/stock_productos', $this->data);
    }
    ...
    function registrar_productos(){  // de inventario
        ...
        $this->template->load('view_layout_modern', 'inventarios/registrar_productos', $this->data);
    }
    ...
    function ver_inventario($id){
        ...
        $this->data['id_inv']       = $id;
        $this->data['page_title']   = $id . ') ' . $titulo;
        $this->template->load('view_layout_modern', 'inventarios/ver_inventario', $this->data);
    }
    ...
    function kardex(){
        ...
        if(strlen($product_id)>0){
            ...
            $this->template->load('view_layout_modern', 'inventarios/kardex', $this->data);    
        }
    }
    ...
    function actualizar_stock(){
        ...
        $this->template->load('view_layout_modern', 'inventarios/actualiza_stock', $this->data);
    ...
    function listar_stock(){ // LISTA STOCK DE LA TABLA tec_prod_store
        ...
        $this->template->load('view_layout_modern', 'inventarios/listar_stock', $this->data);    
    }
