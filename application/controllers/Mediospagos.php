...
class Mediospagos extends CI_controller
{
    ...
    function index(){
        ...
        $this->template->load('view_layout_modern', 'mediospagos/index', $this->data);
    }
    ...
    function add(){
        ...
        $this->template->load('view_layout_modern', 'mediospagos/add', $this->data);
    }
    ...
    function edit($id){
        ...
        $this->template->load('view_layout_modern', 'categorias/add', $this->data);
    }
