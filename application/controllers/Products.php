...
class Products extends CI_controller
{
    ...
    function index($store_id="0",$tipo='P',$categoria="0") {
        ...
        $this->template->load('view_layout_modern', 'products/index', $this->data);
    }
    ...
    function add($id = null){
        ...
        $this->template->load("view_layout_modern", 'products/add', $this->data);
    }
    ...
    function add_servicio($id = null){
        ...
        $this->template->load("view_layout_modern", 'products/add_servicio', $this->data);
    }
    ...
    function print_inicial(){
        ...
        $this->template->load("view_layout_modern", 'products/print_inicial', $this->data);
    }
    ...
    function print_compra($viene_de_guardar=""){
        ...
        $this->template->load("view_layout_modern", 'products/print_compra', $this->data);
    }
    ...
    */
    ...
    function leer_csv(){
        ...
        $this->template->load('view_layout_modern', 'products/importacion', $data);
