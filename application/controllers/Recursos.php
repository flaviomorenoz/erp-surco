...
class Recursos extends CI_Controller //MY_Controller
{
    ...
    function login(){
        ...
        if(isset($_POST["txt_pass"])){
            ...
            if ($pass == '5lcdls5'){
                ...
                $this->template->load('view_layout_modern', 'recursos/login', $this->data);
            }else{
                $bandera = false;
            }
        }else{
        ...
        if(!$bandera){
            ...
            $this->template->load('view_layout_modern', 'recursos/ver_personal', $this->data);
        }
    }*/
    ...
    function agregar_personal(){
        ...
        $this->template->load('view_layout_modern', 'recursos/agregar_personal', $this->data);
    }
