...
class Reportes extends CI_Controller {
    ...
    function ventas_detalles_prod($cDesde='null', $cHasta='null', $cStore_id='null') {
        ...
        $this->template->load('view_layout_modern', 'reportes/ventas_detalles_prod', $this->data);
    }
    ...
    function ventas_por_forma_pago($cDesde='null', $cHasta='null', $cStore_id='null') {
        ...
        $this->template->load('view_layout_modern', 'reportes/ventas_por_forma_pago', $this->data);
    }
    ...
    function grafico_mensual_ventas($desde="", $hasta="", $store_id="", $tipo=""){
        ...
        $this->template->load('view_layout_modern', 'reportes/grafico_mensual_ventas', $this->data);
    }
    ...
    function ganancias($cDesde='null', $cHasta='null', $cStore_id='null') {
        ...
        $this->data['store_id'] = $cStore_id;
        $this->data['Admin'] = $this->Admin;
        $this->template->load('view_layout_modern', 'reportes/ganancias', $this->data);
    }
    ...
    function ganancias_detallado($cDesde='null', $cHasta='null', $cStore_id='null') {
        ...
        $this->data['store_id'] = $cStore_id;
        $this->data['Admin'] = $this->Admin;
        $this->template->load('view_layout_modern', 'reportes/ganancias_detallado', $this->data);
    }
    ...
    function productos_sin_compra(){
        ...
        $this->template->load('view_layout_modern', 'reportes/productos_sin_compra', $this->data);        
    }
    ...
    function analisis(){
        ...
        if(isset($_POST["desde"])){
            ...
            $this->template->load('view_layout_modern', 'reportes/analisis', $this->data);
        }
    ...
    function contabilidad($desde="null", $hasta="null", $store_id=""){
        ...
        $this->data['Admin'] = $this->Admin;
        $this->template->load('view_layout_modern', 'reportes/contabilidad', $this->data);
    }
