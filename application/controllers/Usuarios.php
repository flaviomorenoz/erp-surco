...
class Usuarios extends CI_Controller {
    ...
    function ver_usuarios(){
        ...
        $this->template->load('view_layout_modern', 'usuarios/index', $this->data);
    }
    ...
    function add(){
        ...
        $this->template->load('view_layout_modern', 'usuarios/add_usuarios', $this->data);
    }
    ...
    function permiso_usuarios($id){
        ...
        $this->data['page_title'] = 'Agregar Usuarios:';
        $this->template->load('view_layout_modern', 'usuarios/permiso_usuarios', $this->data);    
    }
}