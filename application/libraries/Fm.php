    ...
    function menu_principal2($Admin, $store_id, $multi_store){ ?>
        ...
        <nav class="modern-sidebar" id="modernSidebar">
            ...
            <div class="sidebar-header">
                ...
                <span class="logo-text">ERP Tienda-en-linea</span>
            </div>
            ...
            <div class="sidebar-user">
                ...
                <div class="user-info">
                    <div class="user-name"><?= $_SESSION["nombre"] ?? 'Admin' ?></div>
                    <div class="user-role"><?= $_SESSION["group_id"] == "1" ? 'Administrador' : 'Usuario' ?></div>
                </div>
            </div>
            ...
            <ul class="sidebar-nav">
                ...
                <li class="nav-section">Módulos</li>
                ...
                <li class="nav-item has-submenu">
                    ...
                    <ul class="sub-menu">
                        <li><a href="<?= base_url('sales/index'); ?>"><span class="sub-icon"><i class="fa fa-circle"></i></span> Listar Ventas</a></li>
                        <li><a href="<?= base_url('sales/add'); ?>"><span class="sub-icon"><i class="fa fa-circle"></i></span> Nueva Venta</a></li>
                    </ul>
                </li>
                ...
                <li class="nav-item has-submenu">
                    ...
                    <ul class="sub-menu">
                        <li><a href="<?= base_url('compras/index'); ?>"><span class="sub-icon"><i class="fa fa-circle"></i></span> Listar Compras</a></li>
                        <li><a href="<?= base_url('compras/add'); ?>"><span class="sub-icon"><i class="fa fa-circle"></i></span> Nueva Compra</a></li>
                    </ul>
                </li>
                ...
                <li class="nav-item has-submenu">
                    ...
                    <ul class="sub-menu">
                        <li><a href="<?= base_url('clientes/index'); ?>"><span class="sub-icon"><i class="fa fa-circle"></i></span> Listar Clientes</a></li>
                        <li><a href="<?= base_url('clientes/add'); ?>"><span class="sub-icon"><i class="fa fa-circle"></i></span> Nuevo Cliente</a></li>
                    </ul>
                </li>
                ...
                <li class="nav-item has-submenu">
                    ...
                    <ul class="sub-menu">
                        <li><a href="<?= site_url('categorias/index'); ?>"><span class="sub-icon"><i class="fa fa-circle"></i></span> Listar Categorías</a></li>
                        <li><a href="<?= site_url('categorias/add'); ?>"><span class="sub-icon"><i class="fa fa-circle"></i></span> Nueva Categoría</a></li>
                    </ul>
                </li>
                ...
                <li class="nav-item has-submenu">
                    ...
                    <ul class="sub-menu">
                        <li><a href="<?= base_url('proveedores/index'); ?>"><span class="sub-icon"><i class="fa fa-circle"></i></span> Listar Proveedores</a></li>
                        <li><a href="<?= base_url('proveedores/add'); ?>"><span class="sub-icon"><i class="fa fa-circle"></i></span> Nuevo Proveedor</a></li>
                    </ul>
                </li>
                ...
                <li class="nav-item has-submenu">
                    ...
                    <ul class="sub-menu">
                        <li><a href="<?= base_url('inventarios/index'); ?>"><span class="sub-icon"><i class="fa fa-circle"></i></span> Ver Inventario</a></li>
                        <li><a href="<?= base_url('inventarios/add'); ?>"><span class="sub-icon"><i class="fa fa-circle"></i></span> Agregar Inventario</a></li>
                        <li><a href="<?= base_url('inventarios/registrar_productos'); ?>"><span class="sub-icon"><i class="fa fa-circle"></i></span> Registrar Productos</a></li>
                        <li><a href="<?= base_url('inventarios/kardex'); ?>"><span class="sub-icon"><i class="fa fa-circle"></i></span> Kardex</a></li>
                ...
                <li class="nav-item has-submenu">
                    <a href="#" onclick="toggleSubmenu(this); return false;">
                        <span class="nav-icon"><i class="fa fa-user-shield"></i></span>
                        <span class="nav-text">Usuarios</span>
                        <span class="nav-arrow"><i class="fa fa-chevron-right"></i></span>
                    </a>
                    <ul class="sub-menu">
                        <li><a href="<?= base_url('usuarios/ver_usuarios'); ?>"><span class="sub-icon"><i class="fa fa-circle"></i></span> Ver Usuarios</a></li>
                        <li><a href="<?= base_url('usuarios/add'); ?>"><span class="sub-icon"><i class="fa fa-circle"></i></span> Agregar Usuario</a></li>
                    </ul>
                </li>
                <?php } ?>
            </ul>
        ...
        function toggleSubmenu(element) {
            ...
            var arrow = element.querySelector('.nav-arrow i');
            
            // Close other open submenus
            document.querySelectorAll('.nav-item.has-submenu .sub-menu.open').forEach(function(menu) {
                if (menu !== submenu) {
                    menu.classList.remove('open');
                    var parentArrow = menu.closest('.nav-item').querySelector('.nav-arrow i');
            ...
            document.querySelectorAll('.sidebar-nav .nav-item > a').forEach(function(link) {
                ...
                if (href && currentPath.indexOf(href.replace(/^.*\/\/[^\/]+/, '')) !== -1) {
                    ...
                    if (submenu) {
                        ...
                        var parentArrow = submenu.closest('.nav-item').querySelector('.nav-arrow i');
