...
<div class="row" style="margin-top:10px;">
    <div class="col-xs-5 col-sm-5 col-md-4 col-lg-3">
		...
		<select class="form-control" name="product_id" id="product_id" onchange="document.getElementById('txt_codigo').value = this.value">
		<?php 
    ...
    <div class="col-xs-2 col-sm-2 col-md-2 col-lg-2">
    	<label style="color:white">Productos</label><br>
