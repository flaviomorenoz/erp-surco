						...
						<div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
							<div class="menu_section">
								...
								<ul class="nav side-menu">
									...
									<li><a><i class="fa fa-table" style="color:skyblue"></i> Administraci&oacute;n<span class="fa fa-chevron-down"></span></a>
										<ul class="nav child_menu">
											
											<li><a><i class="glyphicon glyphicon-cog" style="color:skyblue;font-size:16px;"></i> Orden Produccion<span class="fa fa-chevron-down"></span></a>
												<ul class="nav child_menu">
													<li><a href="<?= base_url('op/index') ?>">Listar</a></li>
													<li><a href="<?= base_url('op/add') ?>">Agregar</a></li>
												</ul>
											</li>

											<li><a><i class="fa fa-bicycle" style="color:skyblue"></i> Orden de Despacho<span class="fa fa-chevron-down"></span></a>
												<ul class="nav child_menu">
													<li><a href="<?= base_url('od/index') ?>">Listar</a></li>
													<li><a href="<?= base_url('od/add') ?>">Agregar</a></li>
												</ul>
											</li>

											<li><a><i class="fa fa-first-order" style="color:skyblue;"></i> Orden de Compra<span class="fa fa-chevron-down"></span></a>
												<ul class="nav child_menu">
													<li><a href="<?= base_url('oc/index') ?>">Listar</a></li>
													<li><a href="<?= base_url('oc/add') ?>">Agregar</a></li>
												</ul>
											</li>
